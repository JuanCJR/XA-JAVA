...
import acdemxaMvcprocess.logic.data.ProductMasterSelectionGDO;
import acdemxaMvcprocess.logic.data.ProductMasterSelectionPDO;
...
/**
 * Program logic for Product Master Selection (STKMASELRA).
 *
 * @author KAMALN
 */
public class ProductMasterSelectionExt {

	/**
	 * Initialises the <code>ProductMasterSelectionPDO</code>
	 * object to receive the data to display.
	 */
	public void pgmInitialize() {
		zzsetdspfind();
		stateVariable.setStkprd(stateVariable.getXwabcd());
		stateVariable.setParnam(stateVariable.getXwhltx());
	...
	public ProductMasterSelectionPDO stateVariable = new ProductMasterSelectionPDO();
	public DataCRUD<ProductMaster, String> productMaster = new DataCRUD<ProductMaster, String>(ProductMaster.class, this, new String[] { "xwabcd" }, new char[] { 'A' }, new char[] { 'R' });
	...
	public ProductMasterSelectionGDO gridVariable[] = initArray(ProductMasterSelectionGDO.class, uwRow1 + 1);
}